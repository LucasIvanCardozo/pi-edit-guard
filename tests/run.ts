...
import * as formatterConfigTests from './formatter-config.test.ts';
...
import * as runnerTests from './format/runner.test.ts';
import * as rewriterTests from './format/tool-result-rewriter.test.ts';
